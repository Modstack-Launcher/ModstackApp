    ...
    <>
      <style>
        {`
          ...
          .update-notification {
            animation: notification-enter 0.45s cubic-bezier(0.16, 1, 0.3, 1);
          }

          .update-notification.closing {
            animation: notification-exit 0.45s cubic-bezier(0.16, 1, 0.3, 1) forwards;
          }
      ...
      <div
        className={`update-notification ${
          closing ? 'closing' : ''
        } fixed bottom-4 right-4 z-50 w-80 rounded-[14px] border border-white/10 shadow-2xl overflow-hidden backdrop-blur-xl`}
      ...
      >
        <div className="flex items-start gap-3 p-4">
          <div className="w-8 h-8 rounded-full bg-[#4b77e7]/15 flex items-center justify-center flex-shrink-0 mt-0.5">
            <IconRefresh
              size={15}
              className="text-[#4b77e7] update-icon"
            />
          </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-muted mt-0.5">
              Modstack App v{version} is ready to install. Reload to apply.
            </p>
